...
{
// Fungsi ini akan dijalankan saat tombol keyboard ditekan dan belumdilepas
...
// Saat tombol dilepas, variabel angle dan move diset nol => kameraberhenti
switch (key)
{
...
if (roll == 1){
if (jarak>0){
posXBola-=0.03; //mengatur kecepatan & banyaknya jarakyang ditempuh dlm 1 perulangan
...
if (deltaAngle) {angle += deltaAngle;
orientMe(angle); }
glPushMatrix();
